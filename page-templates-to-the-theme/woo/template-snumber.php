      ...
      <script type="text/javascript">    
        $(function() {    
          ...
          $('#sender-type').change(function() {
            val =  $('#sender-type option:selected').val();
            if(val == 'Chiron'){
              $('#chiron').show("slow");
              $('#system3').hide("slow");
              $('#dualtech').hide("slow");              
      ...
      <form action="thankyou" method="post" >
        <div class="pp-transmitter">
          ...
          <div id="chiron" class="hidden">
            ...
            <br/>
            <span><input type="radio" value="Ethernet" name="chiron-type">Ethernet</span><br/>
            <span><input type="radio" value="GPRS" name="chiron-type">GPRS</span><br/>
            <span><input type="radio" value="Både Ethernet & GPRS" name="chiron-type">Både Ethernet & GPRS</span>
            <br/>
            <br/>  
          </div>
